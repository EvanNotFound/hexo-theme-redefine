...
function itemInterface(item, hideOnTablet) {
  ...
  return `<a class="mt-[15px] flex max-h-[200px] w-[32%] flex-wrap content-center items-center justify-center overflow-hidden rounded-2xl border border-rd-gray-alpha-400 bg-rd-background-100 !p-3 max-[768px]:w-[49%] ${hideOnTablet ? "max-[768px]:hidden" : ""}" href="${url}" title="${item.title}" rel="bookmark">
