...
- [x] 1.1 Add the Redefine-specific `.opencode/commands/changelog.md` prompt and
...
- [x] 1.2 Add reproducible local package commands for generating and checking a
...
- [x] 2.1 Implement the dependency-free Node release-note validator for safe
...
- [x] 2.2 Exercise the validator with representative valid and invalid
...
- [x] 3.1 Add tag-triggered release CI that checks the tag against
  ...
  creation.
- [x] 3.2 Add the non-blocking OpenCode notes job and artifact handoff, pin the
...
- [x] 3.3 Verify that the created published Release continues to trigger the
...
- [x] 4.1 Document the local preview workflow, hypothetical-tag usage, review
